...
public class SimplexFractalNoise implements Filter {

    private FastNoise fastNoise;
    private float frequencyX;
    private float frequencyY;

    public SimplexFractalNoise() {
    ...
    public SimplexFractalNoise(float frequency) {
        this();
        this.frequencyX = frequency;
        this.frequencyY = frequency;
    }

    public SimplexFractalNoise(float frequencyX, float frequencyY) {
        this();
